    ...
    export default function Home() {
        ...
        // Função que lida com os resultados da busca
        const handleSearchResults = (results) => {
           // Verifica se há resultados para filmes ou séries
    const hasMovies = results.movies && results.movies.length > 0;
    const hasTVShows = results.tvShows && results.tvShows.length > 0;

    // Se ambos estiverem vazios, exibe uma única mensagem
    if (!hasMovies && !hasTVShows) {
        ...
        // Caso contrário, exibe resultados separados para filmes e séries
        setMovieList([
            {
                slug: "searchMovies",
            ...
            console.log('Filmes:', results.movies);
            console.log('Séries:', results.tvShows);
        };
        ...
        <div className='home-page'>
            <Header black={blackHeader} onSearch={handleSearchResults} /> {/* Passa a função para o Header */}
